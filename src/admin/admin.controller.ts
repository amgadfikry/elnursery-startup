...
export class AdminController {
  ...
  @ApiOperation({ summary: 'Create a new admin account and send enail with password (admin only)' })
  ...
  @UserType('admin') // Check if the user type is admin
  @UseInterceptors(new TransformInterceptor(ReturnedAdminDto)) // Transform the response to the ReturnedAdminDto
  @ApiOperation({ summary: 'Get list of all admins (admin only)' })
  ...
  @UserType('admin') // Check if the user type is admin
  @UseInterceptors(new TransformInterceptor(ReturnedAdminDto)) // Transform the response to the ReturnedAdminDto
  @ApiOperation({ summary: 'Get admin account using id (admin only)' })
  ...
  @Delete(':id')
  @UserType('admin') // Check if the user type is admin
  @ApiOperation({ summary: 'Delete admin account using id except owner (admin only)' })
